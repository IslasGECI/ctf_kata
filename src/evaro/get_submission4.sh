...
csvsql --query "select id,(${a}*Longitud_tarso*Longitud_tarso+${b}*Longitud_tarso+${c}) as 'target' from 'test4'" pollos_petrel/test4.csv > pollos_petrel/tmp_submission.csv
